...
`data/tenant/fts-setup/migration.sql`, applied per-tenant during
provisioning (`src/lib/tenant-provision.ts`) and again on tenant
migrations.

```sql
-- data/tenant/fts-setup/migration.sql:4
...
```sql
-- data/tenant/fts-setup/migration.sql:7
...
```sql
-- data/tenant/fts-setup/migration.sql:23
...
```sql
-- data/tenant/fts-setup/migration.sql:26
...
`data/tenant/fts-setup/files-fts.sql` mirrors the document setup
