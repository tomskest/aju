#!/usr/bin/env bash
# Regenerate all SDKs from sdks/openapi/openapi.yaml.
#
...
SPEC="$SDK_ROOT/openapi/openapi.yaml"
...
(
  ...
  openapi-python-client generate \
    ...
    --meta none \
    --overwrite
  # --meta none drops the generated package at sdks/python/_generated. Move it
