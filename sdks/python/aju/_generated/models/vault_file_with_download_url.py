...
T = TypeVar("T", bound="VaultFileWithDownloadUrl")



@_attrs_define
class VaultFileWithDownloadUrl:
    """ 
        Attributes:
            id (str):
            filename (str):
            ...
            download_url_expires_at (datetime.datetime | Unset):
     """
    ...
    download_url_expires_at: datetime.datetime | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        download_url_expires_at: str | Unset = UNSET
        if not isinstance(self.download_url_expires_at, Unset):
        ...
        if download_url_expires_at is not UNSET:
            field_dict["downloadUrlExpiresAt"] = download_url_expires_at
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _download_url_expires_at = d.pop("downloadUrlExpiresAt", UNSET)
        download_url_expires_at: datetime.datetime | Unset
        if isinstance(_download_url_expires_at,  Unset):
            download_url_expires_at = UNSET
        else:
            download_url_expires_at = isoparse(_download_url_expires_at)




        vault_file_with_download_url = cls(
            id=id,
            filename=filename,
            mime_type=mime_type,
            brain_id=brain_id,
        ...
        vault_file_with_download_url.additional_properties = d
        return vault_file_with_download_url
