...
console.log(data?.results);`,
    packageHref:
      "https://github.com/tomskest/aju/tree/main/sdks/typescript",
    packageLabel: "sdks/typescript",
  },
  {
    id: "python",
    label: "Python",
...
for hit in resp.results:
    ...
    packageHref: "https://github.com/tomskest/aju/tree/main/sdks/python",
    packageLabel: "sdks/python",
  },
  {
    id: "go",
    label: "Go",
    install: "go get github.com/tomskest/aju/sdks/go/ajuclient",
    quickstart: `import "github.com/tomskest/aju/sdks/go/ajuclient"
...
resp, _ := c.SearchVault(ctx, &ajuclient.SearchVaultParams{
    ...
    packageHref: "https://github.com/tomskest/aju/tree/main/sdks/go",
    packageLabel: "sdks/go",
  },
];
      ...
      <section className="flex flex-col gap-3 rounded-xl border border-white/5 bg-[var(--color-panel)]/50 px-5 py-4">
        ...
        <ol className="flex flex-col gap-2 font-mono text-[12.5px] leading-[1.7] text-[var(--color-muted)]">
          <li>
            ...
            <a
              href="https://github.com/tomskest/aju/blob/main/sdks/openapi/openapi.yaml"
