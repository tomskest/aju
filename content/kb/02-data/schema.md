...
- **`prisma/control/schema.prisma`** → `@prisma/client`. Holds global identity
...
- **`prisma/tenant/schema.prisma`** → `@prisma/client-tenant`. Applied to every
...
### `Tenant` (`prisma/control/schema.prisma`)
...
### `Brain` (`prisma/tenant/schema.prisma`)
...
### `BrainAccess` (`prisma/tenant/schema.prisma`)
...
`prisma/tenant/rls-policies.sql` enforces this at the DB layer.
...
### `Agent` (`prisma/tenant/schema.prisma`)
...
### `VaultDocument` (`prisma/tenant/schema.prisma`)
...
### `DocumentLink` (`prisma/tenant/schema.prisma`)
...
### `VaultChangeLog` (`prisma/tenant/schema.prisma`)
...
### `VaultFile` (`prisma/tenant/schema.prisma`)
...
### `User` (`prisma/control/schema.prisma`)
...
### `ApiKey` (`prisma/control/schema.prisma`)
...
### `DeviceCode` (`prisma/control/schema.prisma`)
...
### `Organization` (`prisma/control/schema.prisma`)
...
### `OrganizationMembership` (`prisma/control/schema.prisma`)
...
### `Invitation` (`prisma/control/schema.prisma`)
...
### `OrganizationDomain` (`prisma/control/schema.prisma`)
...
### `AccessRequest` (`prisma/control/schema.prisma`)
...
### `WaitlistEntry` (`prisma/control/schema.prisma`)
