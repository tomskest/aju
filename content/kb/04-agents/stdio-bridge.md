...
`https://mcp.aju.sh/mcp` (`apps/cli/cmd/stub.go:19-29`). The stdio server
...
(`src/app/docs/mcp/page.tsx:43-51`):
...
1. Revert the stub at `apps/cli/cmd/stub.go` to actually boot
